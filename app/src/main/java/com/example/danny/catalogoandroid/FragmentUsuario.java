...
public class FragmentUsuario extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_usuario, container, false);
        //TextView nombre = (TextView)view.findViewById(R.id.nombre);
        //nombre.setText("bien");
        ImageView usuario_imagen = (ImageView)view.findViewById(R.id.usuario_imagen);
        TextView nombre = (TextView)view.findViewById(R.id.nombre);
        TextView usuario = (TextView)view.findViewById(R.id.usuario);

        Dapp d = (Dapp)getActivity().getApplication();
    ...
    public void buscar(View view){
        startActivity(new Intent(null,ProductoBuscar.class));
    }
